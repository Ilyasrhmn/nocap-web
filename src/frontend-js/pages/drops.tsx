...
const mockProducts = [
    { id: 1, name: "AIR MAX 95 OG", category: "SHOES", price: 50, image: "https://images.unsplash.com/photo-1600185365483-26d7a4cc7519?q=80&w=800&auto=format&fit=crop", isTrending: true },
    { id: 2, name: "NCP OVERSIZED FLANNEL", category: "OUTERWEAR", price: 30, image: "https://images.unsplash.com/photo-1599508704512-2f19efd1eede?q=80&w=800&auto=format&fit=crop" },
    { id: 3, name: "TRAVIS DUNK LOW", category: "SHOES", price: 45, image: "https://images.unsplash.com/photo-1588636184518-5e88df283623?q=80&w=800&auto=format&fit=crop", isTrending: true },
    { id: 4, name: "HEAVYWEIGHT ZIP HOODIE", category: "HOODIES", price: 35, image: "https://images.unsplash.com/photo-1556821840-3a63f95609a7?q=80&w=800&auto=format&fit=crop" },
    { id: 5, name: "UTILITY CARGO PANTS", category: "PANTS", price: 40, image: "https://images.unsplash.com/photo-1517438476312-10d79c077509?q=80&w=800&auto=format&fit=crop" },
    { id: 6, name: "NCP BEANIE", category: "ACCESSORIES", price: 15, image: "https://images.unsplash.com/photo-1576871337622-98d48d1cf531?q=80&w=800&auto=format&fit=crop" },
    { id: 7, name: "VINTAGE WASH TEE", category: "HOODIES", price: 20, image: "https://images.unsplash.com/photo-1583743814966-8936f5b7be1a?q=80&w=800&auto=format&fit=crop" },
    { id: 8, name: "JORDAN 1 CHICAGO", category: "SHOES", price: 48, image: "https://images.unsplash.com/photo-1542291026-7eec264c27ff?q=80&w=800&auto=format&fit=crop", isTrending: true },
    { id: 9, name: "NYLON WINDBREAKER", category: "OUTERWEAR", price: 42, image: "https://images.unsplash.com/photo-1591047139829-d91aecb6caea?q=80&w=800&auto=format&fit=crop" },
];
                ...
                <main className="flex flex-col md:flex-row px-6 py-8 md:px-12 md:py-12 gap-8 md:gap-12">
                    ...
                    <div className="flex-1 flex flex-col">
                        <div className="mb-6 flex items-center justify-between">
                            <h1 className="text-[32px] font-medium uppercase leading-tight text-ink">{t('nav.drops')}</h1>
                                ...
                                <div key={product.id} className="group relative flex flex-col bg-canvas transition-colors duration-300">
                                    ...
                                    <div className="flex flex-col pt-3 gap-1">
                                        <div className="flex justify-between items-start mt-1">
                                            ...
                                            <p className="text-[16px] font-medium text-ink">{formatPrice(product.price)}</p>
                                        </div>
