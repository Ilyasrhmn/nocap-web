                ...
                <div className="flex-1 flex flex-col gap-12">
                    <section className="flex flex-col">
                        <div className="flex items-center justify-between mb-6">
                            <h2 className="text-[24px] font-medium uppercase leading-tight text-ink">Payment Methods</h2>
                        </div>
                        <div className="flex flex-col items-center justify-center py-24 bg-soft-cloud border border-hairline rounded-none">
                            <CreditCard className="w-12 h-12 text-mute mb-4" />
                            <p className="text-[16px] font-medium text-ink uppercase tracking-widest">No Payment Methods</p>
                            <p className="text-[14px] text-mute mt-2 text-center max-w-sm">
                                Securely save your payment methods here for a frictionless checkout.
                            </p>
