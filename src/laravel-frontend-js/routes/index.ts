...
* @route '/drops'
*/
export const drops = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: drops.url(options),
    method: 'get',
})
...
* @route '/drops'
*/
drops.url = (options?: RouteQueryOptions) => {




    return drops.definition.url + queryParams(options)
}
...
* @route '/drops'
*/
drops.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: drops.url(options),
    method: 'get',
})
...
* @route '/drops'
*/
drops.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: drops.url(options),
    method: 'head',
})
...
* @route '/drops'
*/
const dropsForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: drops.url(options),
    method: 'get',
})
...
* @route '/drops'
*/
dropsForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: drops.url(options),
    method: 'get',
})
...
* @route '/drops'
*/
dropsForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: drops.url({
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'HEAD',
            ...(options?.query ?? options?.mergeQuery ?? {}),
