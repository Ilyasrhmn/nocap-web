...
export default function ShippingReturns() {
    ...
    return (
        <NoCapLayout title="Shipping & Returns">
            <div className="flex-1 w-full max-w-[1440px] mx-auto min-h-[calc(100vh-140px)]">
                ...
                <div className="px-6 md:px-12 py-12 md:py-16 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
                    <div>
                        <p className="text-[14px] font-bold uppercase tracking-widest text-ink mb-1">{t('shipping.cta.q')}</p>
                        <p className="text-[14px] text-mute">{t('shipping.cta.desc')}</p>
                    </div>
                    <a
                        href="/contact"
